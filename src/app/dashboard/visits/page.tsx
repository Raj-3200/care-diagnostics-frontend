...
export default function VisitsPage() {
  ...
  const columns: Column<Visit>[] = [
      ...
      cell: (row) => {
        ...
        return (
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-medium text-foreground">{row.patient.firstName} {row.patient.lastName}</p>
    ...
    },
    {
      header: 'Status',
      cell: (row) => (
        <StatusBadge status={row.status} colorMap={VISIT_STATUS_COLORS} labelMap={VISIT_STATUS_LABELS} />
      ),
    },
    {
  ...
  return (
    <PageTransition>
      <PageHeader
        ...
        action={{ label: 'New Visit', href: '/dashboard/visits/new', icon: <ClipboardPlus className="h-4 w-4" /> }}
      />
